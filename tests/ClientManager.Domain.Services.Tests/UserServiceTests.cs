...
namespace ClientManager.Domain.Services.Tests
{
    public class UserServiceTests
    {
        ...
        {
            // Arrange
            var user = new User("testuser", "test@test.com", "hash", UserRole.Admin);
        ...
        public async Task GetUserByIdAsync_ShouldReturnUserFromRepository()
        {
            // Arrange
            var id = Guid.NewGuid();
            var user = new User("testuser", "test@test.com", "hash", UserRole.Viewer, id);
        ...
        {
            // Arrange
            var user = new User("testuser", "test@test.com", "hash", UserRole.Viewer);
        ...
        public async Task DeleteUserByIdAsync_ShouldCallRepository()
        {
            ...
            // Assert
            _userRepositoryMock.Verify(r => r.DeleteUserByIdAsync(id), Times.Once);
        }
    }
}
